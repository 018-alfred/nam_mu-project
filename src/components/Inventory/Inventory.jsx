...
const Inventory = () => {
    ...
    return (
        <div
            className="flex flex-col items-center font-poppins min-h-screen w-full p-4 bg-gradient-to-r from-orange-400 via-orange-300 to-yellow-200"
        >
            <h1 className="font-bold text-2xl mx-2 mb-4 text-white">Inventory</h1>
            <div className="m-2 mb-3 w-full max-w-md flex items-center gap-2">
                ...
                <div className="flex items-center">
                    <label htmlFor="alert-value" className="mr-2 ml-8 text-white">Alert Value</label>
                    <input
                        id="alert-value"
                    ...
                    />
                    <label className="ml-8 text-white" htmlFor="show-only-depleted">Show Only Depleted</label>
                    <input
            ...
            {filteredInventory.length > 0 ? (
                ...
                <p className="m-2 text-white">No inventory items found.</p>
            )}
        </div>
    );
};
