...
export default function Cart() {
  ...
  return (
    <div
      className="flex flex-col items-center font-bold p-4"
      style={{
        background:
          "linear-gradient(to right, #FB923C, #FDBA74, #FFD580)",
        minHeight: "100vh",
        width: "100vw",
        margin: 0,
        padding: "1rem",
    ...
    >
      <h1 className="text-2xl mb-2 mx-2 text-white">Your Cart</h1>
      {count === 0 ? (
        <p className="text-lg text-gray-100 mx-2">Your cart is empty.</p>
      ) : (
        <div>
          <p className="mx-2 text-white">
            ...
            <button
              ...
              className="bg-green-500 hover:bg-green-600 text-white rounded p-1 m-1 mx-3"
            >
              Checkout Cart
            </button>
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-white rounded p-1 m-1 mx-2"
            >
              Clear Cart
            </button>
          </p>
